 ...
 componentDidMount() {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.studentprofile.profile) {
        const profile = nextProps.studentprofile.profile;
        this.setState({
          bio: profile.bio,
          grade: profile.grade,
...
export default connect(mapStateToProps, { createStudentProfile, getStudentProfile })(withRouter(CreateStudentProfile));
